...
#wm
ls.models$covs[grep('^bl.FA|^bl.MD|^bl.ICVF|^bl.ISOVF|^bl.OD|^g\\.',ls.models$dependent)]=paste0(colnames(targetdata)[4:26],collapse = '+')
ls.models$covs[grep('^FA\\.wm|^MD\\.wm|^ICVF\\.wm|^ISOVF\\.wm|^OD\\.wm',ls.models$dependent)]=paste0(c(colnames(targetdata)[4:26],'hemi'),collapse = '+')
#subcor
ls.models$covs[grep('^ICV$',ls.models$dependent)]=paste0(colnames(targetdata)[4:26],collapse = '+')
ls.models$covs[grep('^vol\\.sub\\.',ls.models$dependent)]=paste0(c(colnames(targetdata)[c(4:26)],'ICV','hemi'),collapse = '+')
ls.models$covs[grep('^bl.vol\\.sub\\.',ls.models$dependent)]=paste0(c(colnames(targetdata)[c(4:26)],'ICV'),collapse = '+')
#T2star
ls.models$covs[grep('^T2\\.star\\.',ls.models$dependent)]=paste0(c(colnames(targetdata)[c(4:26)],'ICV','hemi'),collapse = '+')
#rsfMRI
ls.models$covs[grep('^rsconn|^rsamp',ls.models$dependent)]=paste0(c(colnames(targetdata)[4:26],'r.motion'),collapse = '+')
# the rest - behavioural
ls.models$covs[ls.models$covs=='']=paste0(colnames(targetdata)[c(4,8:26)],collapse = '+')
...
save(result.meta,file='result/i.Main_result/result_meta.RData')
