...
for (f in ls.IM){
      ...
      # visualise
      mr_report(dat,output_path='../results/IM_to_MDD/')
      ...
      ggsave(fig.scatter[[1]], file=paste0("../results/IM_to_MDD/figure/",traitA,'_',traitB,"_scatter_plot.png"), width=5, height=5,dpi=300)
      ggsave(fig.forest[[1]], file=paste0("../results/IM_to_MDD/figure/",traitA,'_',traitB,"_forestr_plot.png"), width=5, height=5,dpi=300)
      ggsave(fig.loo[[1]], file=paste0("../results/IM_to_MDD/figure/",traitA,'_',traitB,"_loo_plot.png"), width=5, height=5,dpi=300)
      ggsave(fig.funnel[[1]], file=paste0("../results/IM_to_MDD/figure/",traitA,'_',traitB,"_funnel_plot.png"), width=5, height=5,dpi=300)     
      system(paste0('echo ',grep(f,ls.IM),' ',traitA,' against ',traitB,'analysis  done >> XS.log'))
}
write.table(MRsummary,file="../results/IM_to_MDD/outcomes.MRsummary",col.names = T,row.names=F,sep="\t",quot=F)
rm(list=ls())