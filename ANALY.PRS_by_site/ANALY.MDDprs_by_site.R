...
library('pbapply')
library('nlme')
result.PRS_x_site=reg_phewasStyle_interaction(ls.models,dat_short=targetdata,dat_long=dat_long,interact_var='MRI_site')

save(result.PRS_x_site,file='result/x.supplementary_materials/PRS_x_site.RData')
